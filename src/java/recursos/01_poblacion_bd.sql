...
SELECT U.ID, 'Jaime', 'Tiro', '03-03-1980', 'C\San Fernando, 21', 'Bormujos', 41930 FROM BABYPLUS.USUARIO U WHERE U.USUARIO = 'CLIENTE';

INSERT INTO BABYPLUS.PROVEEDOR (USUARIO, RAZON_SOCIAL, CIF, DIRECCION, LOCALIDAD, CP, RESPONSABLE)
SELECT U.ID, 'Vera Fisio', 'A1234567', 'C\Ancha, 23', 'Tomares', 41915, 'Carolina' FROM BABYPLUS.USUARIO U WHERE U.USUARIO='PROVEEDOR'