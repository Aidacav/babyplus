...
import servicio.TipoUsuario;

/**
 *
 * @author Aida
 */
@WebFilter(filterName = "UsuarioProveedor", urlPatterns = {"/babyplus/jsp/privado/proveedor/*"})
public class UsuarioProveedor implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (usuario != null && TipoUsuario.PROVEEDOR.toString().equals(usuario.getRol().getDescripcion())) {
