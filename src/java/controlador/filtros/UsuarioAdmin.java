 ...
 * @author Aida
 */
@WebFilter(filterName = "UsuarioAdmin", urlPatterns = {"/babyplus/jsp/privado/admin/*"})
public class UsuarioAdmin implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (usuario != null && TipoUsuario.ADMIN.toString().equals(usuario.getRol().getDescripcion())) {
