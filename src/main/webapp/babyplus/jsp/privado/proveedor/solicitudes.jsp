                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="${pageContext.request.contextPath}/babyplus/jsp/privado/proveedor/gestionCitasProveedor">
                                ...
                                <input class="btn btn-outline-primary" type="submit" name="aceptarSolicitud" value="<fmt:message key="cita.solicitud.aceptar.boton"/>">
                                <input class="btn btn-outline-primary" type="submit" name="rechazarSolicitud" value="<fmt:message key="cita.solicitud.rechazar.boton"/>">
                            </form>
                        </td>
                    </tr>
                </c:forEach>
