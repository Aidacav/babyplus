 ...
 * @author Aida
 */
@WebFilter(filterName = "UsuarioLogado", urlPatterns = {"/babyplus/jsp/privado/*"})
public class UsuarioLogado implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (usuario == null) {
            httpServletRequest.getSession().setAttribute("error", "login.error.no.logado");
            HttpServletResponse httpServletResponse = (HttpServletResponse) response;
            httpServletResponse.sendRedirect(httpServletRequest.getContextPath() + "/babyplus/jsp/paginaLogin.jsp");
        } else {
            httpServletRequest.getSession().setAttribute("idioma", usuario.getIdioma());
